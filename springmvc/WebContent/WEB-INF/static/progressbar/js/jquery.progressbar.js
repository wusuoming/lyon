	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: 'progressbar/images/progressbar.gif',			// boxImage : image around the progress bar
				barImage		: {
									0:	'progressbar/images/progressbg_red.gif',
									30: 'progressbar/images/progressbg_orange.gif',
									70: 'progressbar/images/progressbg_green.gif'
								},
